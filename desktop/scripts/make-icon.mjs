...
const html = `<!doctype html><html><body style="margin:0;background:#12100e;display:flex;align-items:center;justify-content:center;width:100vh;height:100vh">
  <div style="position:relative;width:400px;height:400px;border-radius:24px;background:#bd4a2e;display:flex;align-items:center;justify-content:center">
    <div style="position:absolute;inset:40px;border:5px solid rgba(246,241,232,0.28);border-radius:8px;pointer-events:none"></div>
    <span style="color:#f6f1e8;font-weight:700;font-size:192px;line-height:1;font-family:'Noto Serif SC','Source Han Serif SC','Songti SC','STZhongsong','SimSun',serif;transform:translateY(-1%)">墨</span>
  </div>
</body></html>`;
