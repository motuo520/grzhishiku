...
export const InsufficientBalanceListener: FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] w-80 rounded-2xl border border-danger/30 bg-bg-secondary/95 backdrop-blur-md p-4 shadow-2xl">
      <div className="flex items-start gap-3">
        <div className="mt-0.5 p-2 rounded-xl bg-danger/10 text-danger">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex flex-col gap-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-danger/15 text-danger border border-danger/30 text-xs font-medium hover:bg-danger/25 transition-colors"
            >
              前往充值
