        ...
        <div className="rounded-xl border border-white/[0.06] bg-bg-secondary p-4 mb-6 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              placeholder="引导文件标题"
              className="flex-1 px-3 py-2 rounded-lg bg-bg-primary border border-white/[0.06] text-sm text-text-primary"
            />
          </div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 rounded-lg bg-bg-primary border border-white/[0.06] text-sm text-text-primary min-h-[300px] font-mono leading-relaxed"
          />
          <div className="flex items-center justify-end gap-2">
            <button
              onClick={cancelEdit}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-text-secondary hover:bg-white/[0.04] transition-colors"
            >
              取消
            </button>
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg bg-info/10 text-info hover:bg-info/20 transition-colors disabled:opacity-50 text-xs"
            >
              ...
              <div className="flex items-start justify-between gap-3 mb-2">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    ...
                    className={`p-1.5 rounded-lg transition-colors ${guide.is_active ? 'text-success hover:bg-success/10' : 'text-text-muted hover:bg-white/[0.04]'}`}
                  >
