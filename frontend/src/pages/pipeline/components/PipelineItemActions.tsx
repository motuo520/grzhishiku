    ...
    <div className="flex items-center gap-1.5 shrink-0">
      {canRevert && (
        <button
          ...
          disabled={revertBusy}
          title="退回原始素材"
          className="flex items-center justify-center p-1.5 bg-white/[0.03] border border-white/[0.08] rounded-lg text-text-muted hover:bg-warning/10 hover:border-warning/30 hover:text-warning transition-all disabled:opacity-50"
        >
      ...
      <button
        ...
        disabled={deleteBusy}
        title="删除（可恢复）"
        className="flex items-center justify-center p-1.5 bg-white/[0.03] border border-white/[0.08] rounded-lg text-text-muted hover:bg-danger/10 hover:border-danger/30 hover:text-danger transition-all disabled:opacity-50"
      >
