...
from app.api.admin.endpoints import auth, users, content, logs, dashboard, billing, system, support, tenants, gdpr, monitoring, llm_models
...
admin_router.include_router(llm_models.router, prefix="/llm", tags=["Admin LLM Models"])
